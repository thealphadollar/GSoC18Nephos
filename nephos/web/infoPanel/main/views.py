...
def channels():
    ...
    return Response(json.dumps([dict(r) for r in data]), mimetype='application/json') # http://codeandlife.com/2014/12/07/sqlalchemy-results-to-json-the-easy-way/
...
def show_channels():
    ...
    """
    data = db.session.execute('SELECT * FROM channels;')
    channels = [dict(r) for r in data] # http://codeandlife.com/2014/12/07/sqlalchemy-results-to-json-the-easy-way/
